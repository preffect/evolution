...
```
scoped checks   →  list the ones you ran (e.g. ./validate.sh test --scope server) and their result lines
                   (no gate line: whoever merges runs ./validate.sh all --affected once, right before the merge)
```
