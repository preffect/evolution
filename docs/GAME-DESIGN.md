...
| G13 | seed 42, 1 player A placed at level 1, mass 20 (no DNA); at tick 23 371 the fixture places wild seat 0 at spread 5.0 (mass ≈ 2048 vs 20: duration factor 0.5, 30 ticks) 10 wu east of A (the ECOLOGY W5 setup), so seat 0's engulf of A pays out on tick 23 400 (6:30) | idle                                  | 23 581 ticks | A alive on tick 23 581 (23 400 + 180 + 1); `elapsedTicks` 23 581 → 393.017 s → world level 3.18 → A `dnaCumulative` = 140 = `dnaCatchUpGift`, level 3, `dnaTowardNextLevel` = 0, one offer shown (the protocell draft) and one queued, score 0, no tag points; mass = 0.25 × 413.017 ≈ 103.25 (± 0.01; respawn runs at step 9, after this tick's decay). With A at `dnaCumulative` 200 (level 3) at setup instead: gift 0, level 3, still mass ≈ 103.25.                      |
