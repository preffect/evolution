...
| G2  | seed 42, 1 player                                                                            | idle                                  | 36 000 ticks | `roundPhase` = `'results'`; after a further `RESULTS_SCREEN_SECONDS` × 60 ticks `roundPhase` = `'playing'`, world seed = 43, player level 1, stage `protocell`.                                                                                                       |
