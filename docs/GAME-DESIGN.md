...
| G8  | ECOLOGY E9 setup (A absorbs B at tick 36)                                                                                                                                                                                       | idle                                  | 31 ticks     | leaderboard[0] = A with score = A.dnaCumulative + 25 = 55; B `lifeState` = `'spectating'`, `spectatingPlayerId` = A, no cell for B; at tick 211 (30 + 180 + 1) B alive at starting mass, level, traits and stage unchanged.                                           |
