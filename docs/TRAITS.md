...
| T2  | seed 42, player mass 20 with Cilia Fringe I                                                                              | target 5 radii east                 | 600 ticks | speed within 0.5 wu/s of 242.0 (no decay at starting mass).                                                                                                                                                                                           |
...
| T12 | seed 42, player with Nuclear Envelope II, `dnaTowardNextLevel` 40, engulfed by a placed 100-mass cell                    | idle                                | respawn+1 | `dnaTowardNextLevel` = 20 (50 % kept), level, traits and stage unchanged.                                                                                                                                                                             |
