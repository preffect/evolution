...
| Role        | Value                                                                                         | Used for                                                                                                                                                                                                                                                                         |
| ----------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GAIN`      | `FOOD_MOTE` `#8dff6a`                                                                         | mass-gain floater rims, the edible ring on a cell the own cell can engulf, the Tab panel's gain dots, the up triangle of the effect mark before a trait modifier that helps its owner (`DANGER` draws the down triangle of one that costs; the value's text stays `WHITE`, #453) |
