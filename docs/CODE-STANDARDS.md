...
| `world.ts`, `session.ts`, `controls.ts`, `ladder.ts`, `camera.ts`, `world-clock.ts` | `GAME-DESIGN.md §12`                 | dish, spawn safety, round, seed bound, sprint, `STAGE_ORDER`, camera, the world clock (`WORLD_LEVEL_SECONDS`, `WORLD_MASS_GAIN_PER_SECOND`, `WORLD_STANDING_MASS_TOLERANCE`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `ecology.ts`, `growth.ts`, `absorption.ts`, `wild-cells.ts`                         | `ECOLOGY.md §7`                      | food kinds, spawners (by world stage), zones, decay, curves, engulf, wild cells (`WILD_CELL_*`, `WORLD_ORGANISM_ID`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `progression.ts`                                                                    | `PROGRESSION.md §6`                  | levels, draft weights, timeout, entry rule                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `traits.ts`                                                                         | `TRAITS.md §5`                       | `TRAIT_CATALOG`, `TRAIT_TIERS` (derived from the catalog), `RESERVED_TRAIT_IDS`, `EXCLUSION_GROUPS`; the numbers themselves (`DEFAULT_CELL_MODIFIERS`, one `<ID>_TIERS` table per trait) sit in `trait-modifiers.ts` and are re-exported, so `traits` stays one domain                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `balance.ts`                                                                        | `ARCHITECTURE.md §9`                 | `DEFAULT_BALANCE` (the domain modules spread into plain records, deep-frozen), `BalanceConfig`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `motion.ts`                                                                         | `RENDERING.md §4`                    | the sheet-03 motion clips (keyframes, easing names, durations): cosmetic data read by the renderer, the HUD and the sound bus; never by the server; excluded from `balance.json`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Client render-only numbers (colours, layer z, wobble amplitude, granule count)                                    | `packages/client/src/app/game/render/constants.ts` only (a barrel over the pages `render/constants/{colours,ui-type,own-cell,cell-shape,organelles,vent,world-render,bench}.ts`, so every import still reads `render/constants`); camera numbers are gameplay-visible and live in `camera.ts`; the frame budgets and the bench load (`RENDERING.md §6–§7`) are the `bench` page, ledgered against those tables by `render/bench/render-budget-ledger.spec.ts`; plus the own-cell indicators' reading floors, pill sizes and alphas, whose values are `UI.md §9`'s and are ledgered by the client's `render/constants-ledger.spec.ts` against that table | `UPPER_SNAKE_CASE`, unit suffix                                                          |
| Client input key codes, direction vectors and the DOM selectors the hotkey rules read (`UI.md §4`)                | `packages/client/src/app/game/input/input-constants.ts` only; the steering and sprint tunables stay in `constants/controls.ts` and reach the client through the live `game_state.balance`                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `UPPER_SNAKE_CASE`, unit suffix                                                          |
| Client HUD layout numbers and hint timings (`UI.md §1`)                                                           | `packages/client/src/app/game/hud/hud-constants.ts` only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `UPPER_SNAKE_CASE`, unit suffix                                                          |
