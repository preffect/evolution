...
| Player-facing units: unit words, suffixes, decimals, sign rules (`architecture/encyclopedia.md §12.5`)                  | `packages/client/src/app/game/quantities/quantity-unit.ts` only; every number the HUD or the encyclopedia shows is formatted by `quantities/format-quantity.ts`. Encyclopedia entries type no number at all: their facts read the live balance (§12.3)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `QUANTITY_UNIT` object `UPPER_SNAKE_CASE`, values `snake_case`                           |
