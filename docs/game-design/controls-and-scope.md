...
so the client draws the world no wider than that ratio of its height, centred on the camera: on a wider canvas (a 32:9
screen, a short, wide window) the dish field alone fills the sides, and the camera extent the HUD reads is the drawn
band (#408).
