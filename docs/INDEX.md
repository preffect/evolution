...
## visual-style/ui-type.md (117 lines)

- **Evolution — Visual Style: UI colours and type** (L1–117): §7 of the split `VISUAL-STYLE.md`, which keeps the shared context and the file list.
- **7. UI colours and type** (L5–117): Panels, text, chips and bars use sheet 03's palette table and the HUD / trait-picker layouts.
  - **7.1 Trait glyphs (#312)** (L41–117): One code-drawn SVG glyph per `TraitId` names a trait wherever the HUD lists one: the picker card's medallion (`ui/overlays.md` §3.2) and t…
