...
## engineering/validation-gate.md (122 lines)

- **Engineering Standards: the validation gate** (L1–122): §1 of the split `ENGINEERING.md`, which keeps the shared context and the file list.
- **1. The Validation Gate (`./validate.sh`)** (L5–122): `pnpm -r test`, `pnpm test`, `pnpm typecheck`, `npx tsc`, `pnpm eslint`, `pnpm prettier`, or `pnpm --filter ...
...
## testing/bots-and-design-tables.md (112 lines)

- **Evolution — Testing Standards: bots, proving scenarios and the design tables** (L1–112): §8.3–§8.5 of the split `TESTING.md`, which keeps the shared context and the file list.
  ...
  - **8.5 The design tables** (L94–112): The design tables run on the Evolution adapter: `ecology-spawn.gameplay.test.ts` (E1–E3, E14), `ecology-cells.gameplay.test.ts` (E4–E8,…
