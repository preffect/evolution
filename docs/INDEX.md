...
## ui/overlays.md (131 lines)

- **Evolution — UI: HUD, overlays and onboarding: trait pick, death, results, menu and notices** (L1–131): §3.2–§3.6 of the split `UI.md`, which keeps the shared context and the file list.
  ...
  - **3.6 Notices: toasts and connection states** (L104–131): One toast at a time, top-centre at y 16, `body` on the callout backing, `TOAST_DURATION_SECONDS`, newest replaces oldest, `aria-live="polit…
