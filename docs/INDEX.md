...
## testing/bots-and-design-tables.md (108 lines)

- **Evolution — Testing Standards: bots, proving scenarios and the design tables** (L1–108): §8.3–§8.5 of the split `TESTING.md`, which keeps the shared context and the file list.
  ...
  - **8.5 The design tables** (L94–108): The design tables run on the Evolution adapter: `ecology-spawn.gameplay.test.ts` (E1–E3, E14), `ecology-cells.gameplay.test.ts` (E4–E8,…
