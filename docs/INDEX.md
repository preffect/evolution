...
## ui/overlays.md (205 lines)

- **Evolution — UI: HUD, overlays and onboarding: trait pick, death, results, menu and notices** (L1–205): §3.2–§3.7 of the split `UI.md`, which keeps the shared context and the file list.
  ...
  - **3.7 Hold-Tab "affecting you" panel (`openOverlay === 'leaderboard'` and `lifeState === 'alive'`)** (L149–205): Decision #324 (option C).
