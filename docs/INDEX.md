...
## ui/layout.md (104 lines)

- **Evolution — UI: HUD, overlays and onboarding: layout frame and lobby screens** (L1–104): §1–§2 of the split `UI.md`, which keeps the shared context and the file list.
- **1. Layout frame** (L5–91): Reference viewport `UI_REFERENCE_VIEWPORT_WIDTH_PX` × `UI_REFERENCE_VIEWPORT_HEIGHT_PX` (1280 × 800 CSS px), HUD scale 1.
- **2. Screens (lobby)** (L92–104): The join flow is the template's (#100: "lobby tagline and join flow unchanged"), with the game's config fields and stable test ids added.
