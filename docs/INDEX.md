...
- **Evolution — UI: HUD, overlays and onboarding: trait pick, death, results, menu and notices** (L1–188): §3.2–§3.7 of the split `UI.md`, which keeps the shared context and the file list.
  ...
  - **3.7 Hold-Tab "affecting you" panel (`openOverlay === 'leaderboard'` and `lifeState === 'alive'`)** (L147–188): Decision #324 (option C).
