...
## ecology/absorption.md (252 lines)

- **Evolution — Ecology, Growth and Absorption: absorption and engulf** (L1–252): §6 of the split `ECOLOGY.md`, which keeps the shared context and the file list.
- **6. Absorption and engulf** (L5–252): Decision #139 (direction, confirmed on #145): escape and absorption depend on the traits involved.
  - **6.1 Rules** (L13–199): Eligibility (mass only, one home).
  - **6.2 State diagram** (L200–232): Two records, two homes.
  - **6.3 Edge cases (resolved)** (L233–252)
