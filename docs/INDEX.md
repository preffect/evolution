...
## engineering/validation-gate.md (139 lines)

- **Engineering Standards: the validation gate** (L1–139): §1 of the split `ENGINEERING.md`, which keeps the shared context and the file list.
- **1. The Validation Gate (`./validate.sh`)** (L5–139): `pnpm -r test`, `pnpm test`, `pnpm typecheck`, `npx tsc`, `pnpm eslint`, `pnpm prettier`, or `pnpm --filter ...
