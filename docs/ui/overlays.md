...
tables; the effect text is generated by `describeTierModifiers(balance.traits.TRAIT_TIERS, traitId, tier)` from the
tier's modifier row through a label table (`speedMultiplier: 1.15` → `+15 % speed`; a duration multiplier reads as the
