...
`LIGHT_DIRECTION_DEG`, the ramp reaches `NUCLEUS_RAMP_REACH_RADII` 1.4 r_n, the middle stop is
...
line; at 140 px (r_n 42 px, panel A's own scale) the ramp is analytic, so nothing softens it; in the mid band
