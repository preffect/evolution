...
const TABULATED_WORDS: readonly (readonly [name: string, value: string, written: string])[] = [
  ...
  ['ENCYCLOPEDIA_EFFECTS_TABLE_LABEL', ENCYCLOPEDIA_EFFECTS_TABLE_LABEL, 'Effects by tier'],
  ['ENCYCLOPEDIA_LADDER_TABLE_LABEL', ENCYCLOPEDIA_LADDER_TABLE_LABEL, 'Unlock and ladder'],
  ['ENCYCLOPEDIA_FACTS_TABLE_LABEL', ENCYCLOPEDIA_FACTS_TABLE_LABEL, 'Facts'],
  ['ENCYCLOPEDIA_SEE_ALSO_LABEL', ENCYCLOPEDIA_SEE_ALSO_LABEL, 'See also'],
  ['ENCYCLOPEDIA_TIER_CAPTION_PREFIX', ENCYCLOPEDIA_TIER_CAPTION_PREFIX, 'You own '],
