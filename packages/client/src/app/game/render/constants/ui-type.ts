// The HUD's type scale and its two font stacks (docs/VISUAL-STYLE.md §7, which owns the values).
...
// multiplies by `var(--hud-scale)` (docs/UI.md §1).

/** Labels and body: a system stack, no web fonts and no font files (docs/VISUAL-STYLE.md §7). */
...
/** Tracking on the `label` role: uppercase, 0.08 em (docs/VISUAL-STYLE.md §7). */
