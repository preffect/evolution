// The dish, food, depth, effects, layer order and bench numbers (docs/VISUAL-STYLE.md §1, §2, §5,
// §8; sheet 02; docs/RENDERING.md §6, §7). Units: wu unless the suffix says px, seconds or degrees.

import { RENDER_STAGE, type RenderStageName } from '@evolution/shared';
...
export const RENDER_BENCH_ORBIT_RADIUS_WU = { min: 200, max: 1400 } as const;
...
export const RENDER_BENCH_MOTE_SPREAD_WU = 2800;
export const RENDER_BENCH_VIEWPORT_PX = { width: 1920, height: 1080 } as const;
export const RENDER_BENCH_SAMPLE_CAPACITY = 600;
export const RENDER_STAGE_BUDGET_MS: Readonly<Record<RenderStageName, number>> = {
  [RENDER_STAGE.net]: 1.0,
  [RENDER_STAGE.cells]: 1.2,
  [RENDER_STAGE.organelles]: 1.0,
  [RENDER_STAGE.food]: 0.6,
  [RENDER_STAGE.effects]: 0.3,
  [RENDER_STAGE.camera]: 0.1,
  [RENDER_STAGE.submit]: 1.0,
};
export const RENDER_FRAME_BUDGET_P95_MS = 12;
export const RENDER_GPU_BUDGET_MS = 4;
export const RENDER_HUD_BUDGET_MS = 1;
export const RENDER_MAX_DRAW_CALLS = 16;
export const PERFORMANCE_REPORT_EVERY_FRAMES = 120;
