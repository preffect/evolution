...
import { DEPTH_BOKEH, DEPTH_FAR, DEPTH_NEAR_PARTICLES, WALL_GLASS_WU } from '../constants';
import { DishLayer, createDishFieldSprite, drawDishWall } from './dish-layer';
...
describe('DishLayer', () => {
  it('puts the field sprite, the wall and the far particles under the cells and the near ones above', () => {
    const subject = layer();
    const [field, wall, far] = subject.container.children;
...
describe('createDishFieldSprite / drawDishWall', () => {
