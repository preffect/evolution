...
//
// **Two of U9's assertions are not run here, and neither is a shortcut.**
//
//   * `encyclopedia-entry[…] with encyclopedia-preview` — the lens is ticket #466, blocked on the preview seam
//     (#363). Ticket #465 reserves its box and deliberately carries no `encyclopedia-preview` id: an element with
//     that id and no `data-preview-state` would make this line pass while saying nothing.
