...
export const MODIFIER_FOLD_RULES: Readonly<Record<keyof CellModifiers, FoldRule>> = {
  ...
  absorbDurationMultiplierAsPrey: { fold: MODIFIER_FOLD.multiply },
  wrapDurationMultiplierAsPredator: { fold: MODIFIER_FOLD.multiply },
  absorbDurationMultiplierAsPredator: { fold: MODIFIER_FOLD.multiply },
  gripStrengthBonus: { fold: MODIFIER_FOLD.add },
  gripResistanceBonus: { fold: MODIFIER_FOLD.add },
  struggleSlowdownBonus: { fold: MODIFIER_FOLD.add },
  spitOutChancePerSecond: { fold: MODIFIER_FOLD.add },
