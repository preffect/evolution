...
const LANDED_INTERPOLATION_DELAY_INTERVALS = 2;
...
describe('netcode constants', () => {
  ...
  it('exports the numbers this cadence derives', () => {
    ...
    expect(INTERPOLATION_DELAY_INTERVALS).toBe(LANDED_INTERPOLATION_DELAY_INTERVALS);
