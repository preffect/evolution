// Structural pins of the world clock's constants (docs/game-design/constants-and-acceptance.md §12, docs/ecology/food-and-spawn.md §3.1):
...
/** docs/ecology/food-and-spawn.md §3.1: level-ups at 3:00, 6:00 and 9:00 of a 600 s round. */
const WORLD_LEVEL_UPS_PER_DEFAULT_ROUND = 3;
/** docs/ecology/food-and-spawn.md §3.1: `worldMass` 620 at 10:00 from a starting mass of 20. */
