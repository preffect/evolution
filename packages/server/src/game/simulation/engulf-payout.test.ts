...
/** The third level: seat 0's build owns `nucleoid` and `mitochondrion` (docs/ecology/wild-cells.md §3.3). */
...
interface PayOutOptions {
  /** Which side of the pair is a wild cell (docs/ecology/wild-cells.md §3.3), seated in the player cell's place. */
