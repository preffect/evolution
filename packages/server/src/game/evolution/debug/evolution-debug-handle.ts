...
import type {
  ...
  SpawnedBot,
  SpawnRequest,
} from '../../debug/simulation-debug-handle.js';
import type { GameModule } from '../../game-module.js';
import type { InProcessBotRoster } from '../../../testing/bot-client/in-process-bots.js';
...
export class EvolutionDebugHandle implements Required<SimulationDebugHandle> {
  ...
  /** The roster builds the pilot and the identity; the module adds the player (recorded as a join). */
