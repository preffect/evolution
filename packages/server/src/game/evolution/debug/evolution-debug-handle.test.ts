...
import { DEFAULT_BALANCE, ENTITY_KIND, FOOD_KIND, playerId, type BalanceConfig } from '@evolution/shared';
...
function createHandle() {
  ...
  return { world, recorder, rejections, handle: createEvolutionDebugHandle({ world, recorder, rejections }) };
}
