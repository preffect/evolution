...
/**
 * Gameplay scenarios (docs/testing/scenario-runner.md §8) step a real module for thousands of ticks, so they run
 ...
 * the fake socket and the gameplay scenario tables (docs/testing/tiers-and-builders.md §4). The gameplay framework itself
...
/** A gameplay scenario steps a real module for up to a whole round, twice (docs/testing/scenario-runner.md §8): far past the unit default. */
